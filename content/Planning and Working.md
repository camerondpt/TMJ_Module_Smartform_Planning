...
A link to the overall "Plan" [can be found here](https://planner.cloud.microsoft/webui/v1/premiumplan/55407f36-dae8-4926-baa9-77fb6231d191/org/4b5f9458-a8b7-4ba4-bf15-e55261fdfbdd?tid=f509e65c-8e0b-472d-b270-6ed49b8329dd). This has general goals and timelines listed for different sections of our work. 

Generally we're going to go through Subjective > Objective > Assessment. We'll all get about 10 days to go through what's currently built, propose improvements, and vote them in or out. I'm hoping that suggesting improvements and voting will happen simultaneously, so that we can update the working model and see things in real time as we propose other changes. Please check in on the voting sheet at least every couple of days to vote on new improvements, and as we get a general consensus of approved/not approved I'll update the prototype. A general outline of times is below:
